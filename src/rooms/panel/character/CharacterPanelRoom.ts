...
export class CharacterPanelRoom extends MyRoom<CharacterPanelRoomState> {
  ...
  rebuildState(sender?: MySchema) {
    if (sender == this.state.level || !sender)
      this.state.level = new NumValState(this.player.level, this);
